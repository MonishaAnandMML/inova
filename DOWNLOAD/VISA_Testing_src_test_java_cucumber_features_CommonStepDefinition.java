...
@Given("^Initiate transaction with \"([^\"]*)\" \"([^\"]*)\" CVV as \"([^\"]*)\" \"([^\"]*)\" \"([^\"]*)\" \"([^\"]*)\" \"([^\"]*)\" \"([^\"]*)\" for Amount \"([^\"]*)\" \"([^\"]*)\" \"([^\"]*)\" \"([^\"]*)\"$")
public void initiate_transaction_with_CVV_as_for_Amount(String transactionclassification, String CardNumber, String cvv, String CardProductId, String TranType, String merchantcategorycode, String trackData, String PINdata, String Amount, String CurrencyCodeTransaction, String BusinessZoneCode, String AcqInstitutionId) throws Throwable {
  initializeISOMessage(ISO93bpkg);
	 isoMsg.set(2, CardNumber);
	 isoMsg.set(4, Amount);
	 isoMsg.set(26, merchantcategorycode);
...
//	 isoMsg.set(35, setTrackData2());
	 ...
	 setPINData(PINdata);
	 isoMsg.set(53, "0101010101");
     isoMsg.set(32, AcqInstitutionId);
	 setServiceRestrictionCode();
	 setPOSDataCode(transactionclassification);
	 setCaseNumber(testcasenumber);
	 RRN=isoMsg.getString(37);
 ...
 //Issuer receiving message, processing and sending itback to platform
  ...
  @When("^Message is processed by issuer and repsonse is sent back to the acquirer$")
		public void message_processed_by_issuer_and_response_sent_back_to_acquirer() throws Throwable {
          ...
          System.out.println("issuer receives message at "+Instant.now());
		  ...
		  System.out.println("SEnd processed response at "+Instant.now());
  ...
  public void verify_if_acquirer_received_response_with(String AcquirerResponse_F39, String AmountBilling, String CurrencyCodeBilling, String AmountSettlement, String CurrencyCodeSettlement, String NetworkSettlementAmount, String CurrencyCodeNetwork, String CurrencyCodeTransaction, String BusinessZoneCode) throws Throwable {
...
//		logger.info("Expected acquirer response  == " + NetworkSettlementAmount);
//		logger.info("Expected acquirer response  == " + CurrencyCodeNetwork);
		...
		isoMsg.set(50, CurrencyCodeSettlement);
     	AdditionalData2=setAdditionalData2(NetworkSettlementAmount, CurrencyCodeNetwork);
        isoMsg.set(63, AdditionalData2);
...
//		String NetSetamount = responseMap.get(63);
//		String CrcyCodenetwork = responseMap.get(63);
...
//		System.out.println("Actual field_63   " + NetSetamount + "expected NetworkSettlementAmount" + NetworkSettlementAmount);
//		System.out.println("Actual field_63  " + CrcyCodenetwork + "expected CurrencyCodeNetwork" + CurrencyCodeNetwork);
...
//				&& NetSetamount != null && CrcyCodenetwork != null
...
//				&& NetSetamount.equals(NetworkSettlementAmount)
//				&& CrcyCodenetwork.equals(CurrencyCodeNetwork)
