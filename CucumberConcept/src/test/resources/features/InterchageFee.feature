...
@FCValid_Scenerio_Fees_and_charge_POS_122_branch
...
@FCValid_Scenerio_Fees_and_charge_ATM_122_branch
...
#@FCDeclined_Scenerio_Amount_POS_122_branch_stip
...
#@FCDeclined_Scenerio_Amount_ATM_122_branch_stip
